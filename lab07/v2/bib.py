...
list_of_ingredients = [
    Ingredient("ser", False),
    Ingredient("chleb", False),
    Ingredient("szynka", True),
]

list_of_meals = [
    Meal("kanapki z serem", False, [list_of_ingredients[0], list_of_ingredients[1]]),
    Meal("kanapki z szynką i serem", True, [list_of_ingredients[0], list_of_ingredients[1], list_of_ingredients[2]]),
]
...
def calculate_ingredients(meal1, meal2, count1, count2):
    ing_sum = []
